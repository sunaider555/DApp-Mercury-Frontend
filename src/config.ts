...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'MERCURY-FTM LP': ['0x83A52eff2E9D112E9B022399A9fD22a9DB7d33Ae',18],    //3OMB-WFTM LP
      ...
      '3SHARES-3OMB LP': ['0x83cd44c5175318ac98f82389e5a834e7076418bd', 18],
      '3OMB-TOMB LP': ['0x8252BCE0F34191a276f2a9e0139f8A679F1fdc78', 18],
      '2OMB-TOMB LP': ['0x23C55fFE5EFBE2CFcAd6942B7BC5654F026Cbb3A', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Earn XSHARES by MERCURY-FTM LP',   //I think this should be changed later.
    poolId: 0,
    sectionInUI: 2,
  ...
  ThreeombThreesharesLPTShareRewardPool: { // new
    ...
    finished: false,
    multiplier: '35500x',
    buyLink: 'https://spookyswap.finance/add/0x14def7584a6c52f470ca4f4b9671056b22f4ffde/0x6437adac543583c4b31bf0323a0870430f5cc2e7',
    site: '/',
    sort: 12,
    closedForStaking: false,
  },
  TwoombTombLPTShareRewardPool: { // new
    ...
    finished: false,
    multiplier: '35500x',
    buyLink: 'https://spookyswap.finance/add/0x7a6e4E3CC2ac9924605DCa4bA31d1831c84b44aE/0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7',
    site: '/',
    sort: 13,
    closedForStaking: false,
  },
  // ThreeombTombLPTShareRewardPool: { // new
  //   name: 'Earn 3SHARES by 3OMB-TOMB LP',
  //   poolId: 6,
  //   sectionInUI: 2,
  //   contract: 'ThreeombTombLPTShareRewardPool',
  //   depositTokenName: '3OMB-TOMB LP',
  //   earnTokenName: '3SHARES',
  //   finished: false,
  //   multiplier: '35500x',
  //   buyLink: 'https://spookyswap.finance/add/0x14DEf7584A6c52f470Ca4F4b9671056b22f4FfDE/0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7',
  //   site: '/',
  //   sort: 14,
  //   closedForStaking: false,
  // },
  ...
  //   closedForStaking: false,
  // },
  // Tomb3SHARESRebates: { // Uncomment to enable 3share rebates on frontend
