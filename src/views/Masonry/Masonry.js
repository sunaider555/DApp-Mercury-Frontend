        ...
        <>
          ...
          <Box mt={5}>
            <Grid container justify="center" spacing={3}>
              ...
              <Grid item xs={12} md={2} lg={2} className={classes.gridItem}>
                <Card  style={{ border: '1px solid var(--white)' }}>
                  <CardContent align="center">
                    <Typography>
                      Mercury Price<small> (TWAP)</small>
                    </Typography>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card  style={{ border: '1px solid var(--white)' }}>
                  <CardContent align="center">
                    <Typography>XSHARE Staked</Typography>
            ...
            <Alert variant="filled" severity="warning" style={{  backgroundColor: 'purple', color: 'white !important' }}>
                  Staked XSHAREs can only be withdrawn <b>3</b> epochs after deposit.
            </Alert>
              </Box>
            </Grid>
          ...
          <Box mt={5}>
            <Grid container justify="center" spacing={3} mt={10}  >
              <Button
                ...
                color="primary"
                variant="outlined"
                style={{backgroundColor: '#cdcdcd', color: 'white'}}
              >
                Claim and Withdraw
              </Button>
            </Grid>
