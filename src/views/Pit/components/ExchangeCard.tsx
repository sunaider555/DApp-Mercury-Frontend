...
const ExchangeCard: React.FC<ExchangeCardProps> = ({
  ...
  // if (fromToken.symbol == "TOMB") {
  //   fromSymbol = "MERCURY";
  // } else if (fromToken.symbol == "TBOND") {
  //   fromSymbol = "XBOND";
  // }
  // if (toToken.symbol == "TOMB") {
  //   toSymbol = "MERCURY";
  // } else if (toToken.symbol == "TBOND") {
  //   toSymbol = "XBOND";
  // }
  return (
    <Card>
          ...
          <StyledCardActions>
            {approveStatus !== ApprovalState.APPROVED && !disabled ? (
              <Button
                ...
                onClick={() => catchError(approve(), `Unable to approve ${"TOMB"}`)}  
              >
