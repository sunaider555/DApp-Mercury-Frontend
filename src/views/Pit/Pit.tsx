...
const Pit: React.FC = () => {
  ...
  const handleBuyBonds = useCallback(
    async (amount: string) => {
      ...
      addTransaction(tx, {
        summary: `Buy ${Number(amount).toFixed(2)} XBOND with ${amount} MERCURY`,
      });
    },
            ...
            <StyledBond>
              <StyledCardWrapper>
                <ExchangeCard
                  ...
                  fromTokenName="MERCURY"
                  toToken={tombFinance.TBOND}
                  toTokenName="XBOND"
                  priceDesc={
                    !isBondPurchasable
                      ? 'MERCURY is over peg'
                      : getDisplayBalance(bondsPurchasable, 18, 4) + ' MERCURY available for purchase'
                  }
              ...
              <StyledStatsWrapper>
                ...
                <ExchangeStat
                  tokenName="XBOND"
                  description="Current Price: (MERCURY)^2"
              ...
              <StyledCardWrapper>
                <ExchangeCard
                  ...
                  disabledDescription={!isBondRedeemable ? `Enabled when MERCURY > ${BOND_REDEEM_PRICE}FTM` : null}
                />
              </StyledCardWrapper>
            </StyledBond>
          </>
